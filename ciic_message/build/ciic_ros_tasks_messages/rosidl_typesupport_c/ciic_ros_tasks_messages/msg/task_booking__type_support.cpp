...
static const _TaskBooking_type_support_symbol_names_t _TaskBooking_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ciic_ros_tasks_messages, msg, TaskBooking)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ciic_ros_tasks_messages, msg, TaskBooking)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ciic_ros_tasks_messages, msg, TaskBooking)() {
  return &::ciic_ros_tasks_messages::msg::rosidl_typesupport_c::TaskBooking_message_type_support_handle;
}
